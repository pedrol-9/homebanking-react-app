...
const AccCards = (props) => {
  ...
  return (
    <div className="flex flex-col min-w-[28%] bg-[#1A4D2E] min-h-[25vh] m-10 border rounded-md  py-2 shadow-lg hover:shadow-xl transform transition-transform duration-300 ease-in-out hover:scale-105"  onClick={props.onClick}>

...
const LoansInfo = (props) => {
  return (
    <div className="flex flex-col w-9/12 md:w-4/12 xl:w-3/12 bg-[#1A4D2E] m-8 border rounded-md py-2 shadow-lg hover:shadow-xl transform transition-transform duration-300 ease-in-out hover:scale-105">

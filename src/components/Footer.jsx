...
const Footer = () => {
  ...
  return (
    <>
      <footer className="flex flex-col md:flex-row min-h-[10vh] justify-between items-center w-full text-center text-[#ffffff] italic p-4 bg-gradient-to-r from-[#1A4D2E] via-[#4F6F52] to-[#1A4D2E]">
        <div className='mb-4 sm:mb-0 '>
          <p className='ml-3 text-[#DAA520] '>Copyright &#169; 2024</p>
          <h5 className='text-[#E8DFCA]'>Homebanking App - MindHub Cohort N°54</h5>
          <div className='rounded-md bg-[#85A084] text-[#ffffff] px-3 py-1 mt-4 inline-flex'>
        ...
        <div className="flex flex-wrap justify-center grow my-4 sm:mx-6 md:mx-8 xl:mx-1 gap-4 text-[#ffffff] text-sm ">
        ...
        <div className='flex flex-col items-center gap-2 bg-[#85A084] rounded-lg p-4 md:p-2 lg:p-4 leading-[.9] '>
          <h2 className='font-thin text-[#695608] mb-4'>Follow us on our social media</h2>
          <div className='flex gap-5 md:gap-1  lg:gap-5'>
...
{/* <>
      <footer className="flex flex-col md:flex-row lg:flex-wrap min-h-[10vh] justify-between items-center w-full text-center text-bold text-[#ffffff] italic py-3 px-8 bg-gradient-to-r from-[#1A4D2E] via-[#4F6F52] to-[#1A4D2E]">
        ...
        <div className="flex flex-wrap justify-center lg:w-3/12 xl:w-1/3 xs:mx-3 xl:mx-0 gap-4 mt-4 text-[#ffffff] text-sm">
          <NavLink to="#" className="mr-4 hover:underline">FAQ</NavLink>
          <NavLink to="#" className="mr-4 hover:underline">Send a PQRS</NavLink>
          {loggedIn &&
            <>
        ...
        <div className='flex flex-col items-center gap-4 bg-[#85A084] rounded-lg p-4 mt-4 w-7/12 md:w-4/12 lg:w-2/12  '>

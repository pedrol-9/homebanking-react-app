...
const Home = () => {
  ...
  const handleUsernameChange = (event) => {
    ...
    // Validar el correo electrónico al cambiar
  ...
  const validateEmail = (email) => {
    ...
    // Verificar si el correo electrónico es vacío
    if (!email) {
      return <p className='text-red-500'>Email is required</p>;
    }
    ...
    // Si todo está bien, retornar null (sin error)
    return null;
  };
